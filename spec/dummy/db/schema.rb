...
ActiveRecord::Schema.define(version: 2020_10_07_130822) do
  ...
  create_table "spree_deliveries", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["shipment_id"], name: "index_spree_deliveries_on_shipment_id"
    t.index ["user_id"], name: "index_spree_deliveries_on_user_id"
  end
